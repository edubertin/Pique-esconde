...
- Endereço.
- Coordenadas.
- Local exato da partida.

## Exemplos de Frase

- Sobrevivi ao Pique Esconde.
- Peguei geral no Pique Esconde.
- Rush final insano.
- Esconda. Marque. Corra.

## Decisões CEO Pendentes

- Confirmar frases oficiais do card.
- Confirmar design final do QR code/link de instalação.
